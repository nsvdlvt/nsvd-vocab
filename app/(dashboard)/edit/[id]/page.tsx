...
từ vựng	phiên âm	loại từ	nghĩa tiếng Việt	ví dụ tiếng Anh	synonyms`
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 mb-10">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                        ...
                        className={`px-6 py-4 rounded-2xl font-black transition ${hasWords && hasChanges
    ...
    {showTags && (
        ...
        <div className="absolute z-50 mt-3 w-full bg-white border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.08)] rounded-3xl p-2 animate-dropdown">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
                ...
                <button
                    ...
                    className={`px-8 py-4 rounded-2xl font-black transition ${hasChanges
